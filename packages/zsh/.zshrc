# This is generated by the build to link together
# the build information within the shell environment.
# The name of this file is really odd but it needs to
# be, to avoid potential filename collisions.
DOTFILES_BUILD_ZSH=".dotfiles.zsh"

if [[ -f "$HOME/$DOTFILES_BUILD_ZSH" ]]; then
  source "$HOME/$DOTFILES_BUILD_ZSH"
fi
