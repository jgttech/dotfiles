...
import (
	"context"
	"fmt"
	"jgttech/dotfiles/core/exec"
	"jgttech/dotfiles/core/tui/notice"
	"jgttech/dotfiles/core/tui/spinner"
	"os"
	"strings"
...
var Command = &cli.Command{
	Name:  "save",
	Usage: "Use AI (Claude) to generate a commit based on current changes",
